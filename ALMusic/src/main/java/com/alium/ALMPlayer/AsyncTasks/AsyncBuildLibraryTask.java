 ...
 */
package com.alium.ALMPlayer.AsyncTasks;
...
import com.alium.ALMPlayer.FoldersFragment.FileExtensionFilter;
...
public class AsyncBuildLibraryTask extends AsyncTask<String, String, Void> {
	...
	protected void onPreExecute() {
		...
		wakeLock = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK,
								  "com.alium.ALMPlayer.AsyncTasks.AsyncBuildLibraryTask");
		wakeLock.acquire();

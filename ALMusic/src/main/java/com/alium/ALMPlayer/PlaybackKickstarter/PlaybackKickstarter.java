 ...
 */
package com.alium.ALMPlayer.PlaybackKickstarter;
...
import com.alium.ALMPlayer.DBHelpers.MediaStoreAccessHelper;
...
import com.alium.ALMPlayer.NowPlayingActivity.NowPlayingActivity.NowPlayingActivityListener;
import com.alium.ALMPlayer.Services.AudioPlaybackService;
import com.alium.ALMPlayer.Services.AudioPlaybackService.PrepareServiceListener;
...
public class PlaybackKickstarter implements NowPlayingActivityListener, PrepareServiceListener {
    ...
    public void onNowPlayingActivityReady() {
        ...
        try {
            ...
            e.printStackTrace();
            Log.d("ERROR", "SEE S TRAACE");
            new AlertDialog.Builder(mContext)
                    .setTitle("Error continuing playback")
                    .setMessage(R.string.going_to_main)
                    .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    Toast.makeText(mContext, R.string.restart_app, Toast.LENGTH_SHORT);
                                }
                            }
                    )

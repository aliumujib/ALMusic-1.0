 ...
 */
package com.alium.ALMPlayer.MusicLibraryEditorActivity;
...
import com.alium.ALMPlayer.AsyncTasks.AsyncCreateMusicLibraryTask;
...
import com.alium.ALMPlayer.Utils.TypefaceSpan;
        ...
        switch (item.getItemId()) {
	         ...
	         */
                ...
                if (ArtistsPickerFragment.listView != null) {
                    ...
                    ArtistsPickerFragment.listView.setAdapter(new MusicLibraryEditorArtistsMultiselectAdapter(this, ArtistsPickerFragment.cursor));
                ...
                if (AlbumsPickerFragment.listView != null) {
                    ...
                    AlbumsPickerFragment.listView.setAdapter(new MusicLibraryEditorAlbumsMultiselectAdapter(this, AlbumsPickerFragment.cursor));
                    AlbumsPickerFragment.listView.invalidate();
                }

                if (SongsPickerFragment.listView != null) {
                    SongsPickerFragment.listView.setAdapter(null);
                    SongsPickerFragment.listView.setAdapter(new MusicLibraryEditorSongsMultiselectAdapter(this, SongsPickerFragment.cursor));

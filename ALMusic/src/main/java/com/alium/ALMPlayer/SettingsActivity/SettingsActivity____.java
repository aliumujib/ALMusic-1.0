...
import com.alium.ALMPlayer.InAppBilling.IabResult;
import com.alium.ALMPlayer.InAppBilling.Purchase;
import com.alium.ALMPlayer.Services.AutoFetchAlbumArtService;
	...
	protected void onCreate(Bundle savedInstanceState) {
    	...
    	upgradePreference.setOnPreferenceClickListener(new OnPreferenceClickListener() {
			...
			public boolean onPreferenceClick(Preference preference) {
				//initInAppBilling();
				Intent intent = new Intent(mContext, com.alium.ALMPlayer.LauncherActivity.LauncherActivity.class);

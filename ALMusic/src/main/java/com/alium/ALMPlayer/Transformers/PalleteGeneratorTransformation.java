package com.alium.ALMPlayer.Transformers;
...
/**
 * Created by aliumujib on 8/22/15.
 */
public final class PalleteGeneratorTransformation
    ...
    public PalleteGeneratorTransformation () {
        this (0);
    }

    public PalleteGeneratorTransformation (final int c) {
        numColors = c;
    }

 ...
 */
package com.alium.ALMPlayer.LauncherActivity;
...
import com.alium.ALMPlayer.MiscFragments.TrialFragment;
...
public class LauncherActivity extends FragmentActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (mApp.getSharedPreferences().getBoolean(Common.FIRST_RUN, true)==true) {
	        ...
	        buildingLibraryMainText.setText(R.string.ALMusic_is_building_library);
	        ...
	        buildingLibraryMainText.setText(R.string.ALMusic_is_caching_artwork);
	        initScanProcess(0);

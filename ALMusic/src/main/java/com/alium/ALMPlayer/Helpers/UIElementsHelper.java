 ...
 */
package com.alium.ALMPlayer.Helpers;
...
public class UIElementsHelper {
    ...
    public static Drawable getGeneralActionBarBackground(Context context) {
        ...
        if (mApp.getSharedPreferences().getString(NOW_PLAYING_COLOR, BLUE).equals(BLUE)) {
            drawable = new ColorDrawable(mApp.getResources().getColor(R.color.blue_primaryColor));

        } else if (mApp.getSharedPreferences().getString(NOW_PLAYING_COLOR, BLUE).equals(RED)) {
            drawable = new ColorDrawable(mApp.getResources().getColor(R.color.red_primaryColor));

        } else if (mApp.getSharedPreferences().getString(NOW_PLAYING_COLOR, BLUE).equals(GREEN)) {
            drawable = new ColorDrawable(mApp.getResources().getColor(R.color.green_primaryColor));

        } else if (mApp.getSharedPreferences().getString(NOW_PLAYING_COLOR, BLUE).equals(ORANGE)) {
            drawable = new ColorDrawable(mApp.getResources().getColor(R.color.orange_primaryColor));

        } else if (mApp.getSharedPreferences().getString(NOW_PLAYING_COLOR, BLUE).equals(PURPLE)) {
            drawable = new ColorDrawable(mApp.getResources().getColor(R.color.purple_primaryColor));
    ...
    public static ColorDrawable getGeneralStatusBarBackground(Context context) {

        mApp = (Common) context.getApplicationContext();

        ColorDrawable drawable = new ColorDrawable(0xFFB0120A);
        if (mApp.getSharedPreferences().getString(NOW_PLAYING_COLOR, BLUE).equals(BLUE)) {
            drawable = new ColorDrawable(mApp.getResources().getColor(R.color.blue_primaryDark));

        } else if (mApp.getSharedPreferences().getString(NOW_PLAYING_COLOR, BLUE).equals(RED)) {
            drawable = new ColorDrawable(mApp.getResources().getColor(R.color.red_primaryDark));

        } else if (mApp.getSharedPreferences().getString(NOW_PLAYING_COLOR, BLUE).equals(GREEN)) {
            drawable = new ColorDrawable(mApp.getResources().getColor(R.color.green_primaryDark));

        } else if (mApp.getSharedPreferences().getString(NOW_PLAYING_COLOR, BLUE).equals(ORANGE)) {
            drawable = new ColorDrawable(mApp.getResources().getColor(R.color.orange_primaryDark));

        } else if (mApp.getSharedPreferences().getString(NOW_PLAYING_COLOR, BLUE).equals(PURPLE)) {
            drawable = new ColorDrawable(mApp.getResources().getColor(R.color.purple_primaryDark));
    ...
    public static Drawable getProgressDrawable(Context context) {
        ...
        Drawable drawable = mApp.getResources().getDrawable(R.drawable.progress_horizontal_apptheme);
        if (mApp.getSharedPreferences().getString(NOW_PLAYING_COLOR, BLUE).equals(BLUE)) {
            drawable = mApp.getResources().getDrawable(R.drawable.progress_horizontal_apptheme);

        } else if (mApp.getSharedPreferences().getString(NOW_PLAYING_COLOR, BLUE).equals(RED)) {
            drawable = mApp.getResources().getDrawable(R.drawable.progress_horizontal_appthemered);

        } else if (mApp.getSharedPreferences().getString(NOW_PLAYING_COLOR, BLUE).equals(GREEN)) {
            drawable = mApp.getResources().getDrawable(R.drawable.progress_horizontal_appthemegreen);

        } else if (mApp.getSharedPreferences().getString(NOW_PLAYING_COLOR, BLUE).equals(ORANGE)) {
            drawable = mApp.getResources().getDrawable(R.drawable.progress_horizontal_appthemeorange);

        } else if (mApp.getSharedPreferences().getString(NOW_PLAYING_COLOR, BLUE).equals(PURPLE)) {
            drawable = mApp.getResources().getDrawable(R.drawable.progress_horizontal_appthemepurple);

        } else if (mApp.getSharedPreferences().getString(NOW_PLAYING_COLOR, BLUE).equals(MAGENTA)) {
            drawable = mApp.getResources().getDrawable(R.drawable.progress_horizontal_appthememagenta);
        }
